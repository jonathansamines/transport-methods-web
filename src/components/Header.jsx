        ...
        <nav>
          <ul className="nav nav-pills pull-right">
            <li role="presentation" className={this.state.isMc}>
              <a href="#" onClick={this.setActiveMenu('mc')}>Costo Minimo</a>
            </li>
            <li role="presentation" className={this.state.isTransbord}>
              <a href="#" onClick={this.setActiveMenu('trans')}>Metodo de Transbordos</a>
            </li>
          </ul>
        </nav>
        <h3 className="text-muted">Metodos de Transporte</h3>
      </div>
    );
  }
}
